...
|REX + 20 /r|`AND` r/m8\footnote{\htmlonly{*}} r8\footnote{\htmlonly{*}} |MR|Valid|N.E.|r/m64 AND r8 (sign-extended).|
...
|REX + 22 /r|`AND` r8\footnote{\htmlonly{*}} r/m8\footnote{\htmlonly{*}} |RM|Valid|N.E.|r/m64 AND r8 (sign-extended).|
