...
|------------------------------------|------------------------|--------------------------------|--------------------------------------------------|---------------|
|VEX.NDS.128.66.0F38.W0 2C /r\newline{}\newline{}VMASKMOVPS xmm1, xmm2, m128|RVM|V/V|AVX|Conditionally load packed single-precision values from m128 using mask in xmm2 and store in xmm1.|
|VEX.NDS.256.66.0F38.W0 2C /r\newline{}\newline{}VMASKMOVPS ymm1, ymm2, m256|RVM|V/V|AVX|Conditionally load packed single-precision values from m256 using mask in ymm2 and store in ymm1.|
|VEX.NDS.128.66.0F38.W0 2D /r\newline{}\newline{}VMASKMOVPD xmm1, xmm2, m128|RVM|V/V|AVX|Conditionally load packed double-precision values from m128 using mask in xmm2 and store in xmm1.|
|VEX.NDS.256.66.0F38.W0 2D /r\newline{}\newline{}VMASKMOVPD ymm1, ymm2, m256|RVM|V/V|AVX|Conditionally load packed double-precision values from m256 using mask in ymm2 and store in ymm1.|
|VEX.NDS.128.66.0F38.W0 2E /r\newline{}\newline{}VMASKMOVPS m128, xmm1, xmm2|MVR|V/V|AVX|Conditionally store packed single-precision values from xmm2 using mask in xmm1.|
|VEX.NDS.256.66.0F38.W0 2E /r\newline{}\newline{}VMASKMOVPS m256, ymm1, ymm2|MVR|V/V|AVX|Conditionally store packed single-precision values from ymm2 using mask in ymm1.|
|VEX.NDS.128.66.0F38.W0 2F /r\newline{}\newline{}VMASKMOVPD m128, xmm1, xmm2|MVR|V/V|AVX|Conditionally store packed double-precision values from xmm2 using mask in xmm1.|
|VEX.NDS.256.66.0F38.W0 2F /r\newline{}\newline{}VMASKMOVPD m256, ymm1, ymm2|MVR|V/V|AVX|Conditionally store packed double-precision values from ymm2 using mask in ymm1.|
