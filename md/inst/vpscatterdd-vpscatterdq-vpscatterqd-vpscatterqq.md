...
|------------------------------------|-----------------------|------------------------------------------------------|--------------------------------------------------|---------------|
|EVEX.128.66.0F38.W0 A0 /vsib \newline{}VPSCATTERDD vm32x {k1}, xmm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed dword indices, scatter dword values to memory using writemask k1.|
|EVEX.256.66.0F38.W0 A0 /vsib\newline{}VPSCATTERDD vm32y {k1}, ymm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed dword indices, scatter dword values to memory using writemask k1.|
|EVEX.512.66.0F38.W0 A0 /vsib \newline{}VPSCATTERDD vm32z {k1}, zmm1|T1S|V/V|AVX512F|Using signed dword indices, scatter dword values to memory using writemask k1.|
|EVEX.128.66.0F38.W1 A0 /vsib \newline{}VPSCATTERDQ vm32x {k1}, xmm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed dword indices, scatter qword values to memory using writemask k1.|
|EVEX.256.66.0F38.W1 A0 /vsib \newline{}VPSCATTERDQ vm32x {k1}, ymm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed dword indices, scatter qword values to memory using writemask k1.|
|EVEX.512.66.0F38.W1 A0 /vsib \newline{}VPSCATTERDQ vm32y {k1}, zmm1|T1S|V/V|AVX512F|Using signed dword indices, scatter qword values to memory using writemask k1.|
|EVEX.128.66.0F38.W0 A1 /vsib \newline{}VPSCATTERQD vm64x {k1}, xmm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed qword indices, scatter dword values to memory using writemask k1.|
|EVEX.256.66.0F38.W0 A1 /vsib \newline{}VPSCATTERQD vm64y {k1}, xmm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed qword indices, scatter dword values to memory using writemask k1.|
|EVEX.512.66.0F38.W0 A1 /vsib \newline{}VPSCATTERQD vm64z {k1}, ymm1|T1S|V/V|AVX512F|Using signed qword indices, scatter dword values to memory using writemask k1.|
|EVEX.128.66.0F38.W1 A1 /vsib \newline{}VPSCATTERQQ vm64x {k1}, xmm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed qword indices, scatter qword values to memory using writemask k1.|
|EVEX.256.66.0F38.W1 A1 /vsib \newline{}VPSCATTERQQ vm64y {k1}, ymm1|T1S|V/V|AVX512VL\newline{}AVX512F|Using signed qword indices, scatter qword values to memory using writemask k1.|
|EVEX.512.66.0F38.W1 A1 /vsib\newline{}VPSCATTERQQ vm64z {k1}, zmm1|T1S|V/V|AVX512F|Using signed qword indices, scatter qword values to memory using writemask k1.|
