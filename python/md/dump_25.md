...
이차원 배열은 쉽게 생각해서 1 차원 배열이 여러 개 있다고 생각하시면 됩니다. 위 경우 `int a[3]` 짜리 배열 2 개가 메모리에 연속적으로 존재한다고 생각하시면 됩니다. 
...
![caption=`arr[0][0]`, `arr[0][1]` .... `arr[a-1][b-1]` 까지 쭈르륵 나열된 모습](http://img1.daumcdn.net/thumb/R1920x0/?fname=http%3A%2F%2Fcfile24.uf.tistory.com%2Fimage%2F1547A2204B0BA8833543A1)
...
![caption=물론 메모리 상에서는 실제로 선형으로 존재한다는 것 아시죠!](http://img1.daumcdn.net/thumb/R1920x0/?fname=http%3A%2F%2Fcfile24.uf.tistory.com%2Fimage%2F1445F9204B0BABC63D97B6)
