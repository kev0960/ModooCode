...
이번 강좌에서는
* Visual Studio 2010 을 설치한다.첫 번째 C++ 프로그램을 만든다. 
...
1. 인터넷이 되는 컴퓨터. 특히 http://itguru.tistory.com 이 수월하게 들어가져야 함뇌개념씹어먹는 C 언어를 다 배움으로써 얻을 수 있는 지식컴파일러
...
공감sns신고저작자표시'C++' 카테고리의 다른 글씹어먹는 C++ - <3. C++ 의 세계로 오신 것을 환영합니다. (new, delete)>(41)
