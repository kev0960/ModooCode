...
사실 여러분들은 C++ 컴파일러를 이미 다 컴퓨터에 설치하고 계실 것입니다. 왜냐구요? 이전에 C 언어를 배울 때 설치하였던 Visual Studio 2008 에 C 및 C++ 컴파일러가 모두 다 들어있기 때문이지요.\sidenote{이 글만 보아도 이 강좌의 세월을 느낄 수 있습니다. 제가 C++ 강의를 시작한 것이 2011 년 입니다. 하지만 2019년 현재 아직도 지속적으로 업데이트 하고 있습니다.}
