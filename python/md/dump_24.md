...
이번 강좌에서는* 상수 포인터(const int*, int* const)포인터의 덧셈, 뺄셈
배열과 포인터와의 관계[] 연산자![신나는 씹어먹는 C 언어!](http://img1.daumcdn.net/thumb/R1920x0/?fname=http%3A%2F%2Fcfile8.uf.tistory.com%2Fimage%2F137907014AFE246AA02DDE)
...
```
공감sns신고저작자표시'C' 카테고리의 다른 글씹어먹는 C 언어 - <13 - 1. 마술 상자 함수(function)>(122)
