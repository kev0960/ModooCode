...
  `Google` 의 C++ 변수 이름 짓기 가이드에 따르면 ( [http://google-styleguide.googlecode.com/svn/trunk/cppguide.xml#General_Naming_Rules](http://google-styleguide.googlecode.com/svn/trunk/cppguide.xml#General_Naming_Rules)`)` 에서 보실 수 있습니다. 다음과 같이 하기를 권장합니다.
