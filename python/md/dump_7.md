...
이번 강좌에서 배우게 될 것은
* 변수란 무엇인가?정수형, 실수형 변수16 진법, 메모리 주소변수 이름 짓기* ![](http://img1.daumcdn.net/thumb/R1920x0/?fname=http%3A%2F%2Fcfile2.uf.tistory.com%2Fimage%2F1930411049F08D5BC68580)
...
* 숫자가 앞에 위치하면 안됩니다. 그러나 중간이나 뒤는 괜찮습니다. 변수명은 오직 영어, 숫자, _ 로 만 구성되어 있어야 합니다.변수의 이름에 띄어쓰기가 있으면 안됩니다.변수의 이름이 C 언어 예약어 이면 안됩니다. 보통 예약어를 쓰면 파란색 글자체로 표시되어 예약어를 썼는지 안썼는지 알 수 있습니다. 
...
```
공감2sns신고'C' 카테고리의 다른 글씹어먹는 C 언어 - <6. 만약에...(if 문)>(182)
