...
1. `>` : 좌변이 우변보다 크면 참이 됩니다. (`6 > 3` : 참, `6 > 6` : 거짓, `6 > 8` : 거짓)
1. `<=` : 좌변이 우변보다 작거나 같으면 참이 됩니다. (`6 <= 3` : 거짓, `6 <= 6` : 참, `6 <= 8` : 참)
1. `<` : 좌변이 우변보다 작으면 참이 됩니다.(`6 < 3` : 거짓, `6 < 6` : 거짓, `6 < 8` : 참)
1. `==` : 좌변과 우변이 같으면 참이 됩니다.(`6 == 3` : 거짓, `6 == 6` : 참, `6 == 8` : 거짓)
1. `!=` : 좌변과 우변이 다르면 참이 됩니다. (`6 != 3` : 참, `6 != 6` : 거짓, `6 != 8` : 참)
